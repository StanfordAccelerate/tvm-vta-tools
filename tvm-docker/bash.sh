...
# Modification:
# Zheng Liang - 2019 Nov 22
# seperate $TVM_ROOT mounted 

# Start a bash, mount /workspace to be current directory, also
# mount /tvm to be $TVM_ROOT
# 
#
...
# Print arguments.
echo "TVM_ROOT: ${TVM_ROOT}"  # zheng hack
